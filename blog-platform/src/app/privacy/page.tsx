  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-24 lg:px-8">
      <div className="rounded-[40px] border border-slate-200/80 bg-white p-10 shadow-sm dark:border-slate-800 dark:bg-slate-900 transition-colors">
        ...
        <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-300">We use data only to provide account management, publishing workflows, analytics, and email communication. Readers can request access, correction, or deletion of personal data at any time.</p>
      </div>
    </div>
  );
}
