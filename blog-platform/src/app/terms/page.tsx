  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-24 lg:px-8">
      <div className="rounded-[40px] border border-slate-200/80 bg-white p-10 shadow-sm">
        ...
        <p className="mt-6 text-lg leading-8 text-slate-600">The service is available for lawful publishing, reading, commenting, and moderation. Users should not upload harmful content, bypass security controls, or abuse the platform.</p>
      </div>
    </div>
  );
}
